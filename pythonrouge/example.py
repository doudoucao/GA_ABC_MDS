...
if __name__ == '__main__':
    ...
    # summary_dir = "/home/zixuan/PycharmProjects/doudou_c/genetic-swarm-MDS/result_1/"
    summary_dir = "/home/zixuan/PycharmProjects/doudou_c/genetic-swarm-MDS/genetic_summy_result"
    reference_dir = "/home/zixuan/PycharmProjects/doudou_c/genetic-swarm-MDS/models/"
    # reference_dir = "./sample/reference/"
    # setting rouge options
    rouge = Pythonrouge(n_gram=2, ROUGE_SU4=True, ROUGE_L=True, stemming=True, stopwords=True, word_level=True,
                        length_limit=True, length=250, use_cf=False, cf=95, scoring_formula="average", resampling=True,
