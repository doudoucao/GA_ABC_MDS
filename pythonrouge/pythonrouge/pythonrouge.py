...
class Pythonrouge:
    def __init__(self, n_gram=2, ROUGE_SU4=True, ROUGE_L=False, ROUGE_W=False, ROUGE_W_Weight=1.2, stemming=True,
                 stopwords=False, word_level=True, length_limit=True, length=100, use_cf=False, cf=95,
        ...
        samples: specify the number of sampling point in bootstrap resampling (default is 1000).
    ...
    def setting(self, files=True, summary_path="./", reference_path="./", summary=[], reference=[], delete=True,
        ...
        for n, sys in enumerate(glob.glob("{}/*".format(summary_path))):
            ...
            for path, ids in zip(glob.glob("{}/{}*".format(reference_path, file_name)),
                                 ["A", "B", "C", "D", "E", "F", "G"]):
    ...
    def eval_rouge(self, xml_path, recall_only=False, f_measure_only=False, ROUGE_path="./RELEASE-1.5.5/ROUGE-1.5.5.pl",
