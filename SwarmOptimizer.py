...
class SwarmOptimizer(object):
    def __init__(self, fitness_fun, docs, docs_representation, max_length, number_locations, trial_limit, mfe,
                 args=None, maximization=False):
        np.random.seed(123)
        ...
        for doc in docs:
            ...
            for s in doc:
                self._sentence_tokens.append(sentence_token(s))
